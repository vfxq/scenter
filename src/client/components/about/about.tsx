...
export class About extends React.Component {
  public render() {
    return (
      <Section height={600} style={css}>
        <h1>О духовном центре</h1>
        <div className="bg_pict">
          <div className="about">
            Духовный центр - это сообщество мастеров из разных частей нашей страны. Еще нас называют колдунами, магами, экстрасенсами, ведьмами... Наша профессиональная область - магия, окультные знания и духовные практики.
